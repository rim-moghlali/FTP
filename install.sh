#!/bin/bash
#installer proftpd et filezilla
apt-get install proftpd-*

# mettre le chemin pour acceder aux fichiers a modifier
cd /etc/proftpd
...
#   # in e ach newly chdired directory.
   DisplayLogin welcome.msg
...
#generation de la cle et cerification
